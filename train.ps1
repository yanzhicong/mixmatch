...
# python mixup_sl.py --scales 3 --repeat 2 --filters=128 --dataset=miniimagenet-50 --beta=0.8 --whiten --arch resnet18  --batch 64 --epochs 400 --decay_start_epoch 50 
# python mixup_sl.py --scales 3 --repeat 2 --filters=128 --dataset=miniimagenet-50 --beta=1.0 --whiten --arch resnet18  --batch 64 --epochs 400 --decay_start_epoch 50 
python mixup_sl.py --scales 3 --repeat 2 --filters=128 --dataset=miniimagenet-50 --beta=0.0 --whiten --arch bcnn_resnet18  --batch 64 --epochs 400 --decay_start_epoch 50 
