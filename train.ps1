...
python deeplp.py --scales 4 --repeat 2 --filters=64 --dataset=miniimagenet.2@40-50 --w_match=75 --beta=1.0 --whiten --arch resnet18  --batch 64 --epochs 400 --decay_start_epoch 50 
