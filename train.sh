...
CUDA_VISIBLE_DEVICES=0 python mixup_sl.py --scales 4 --repeat 2 --filters=64 --dataset=miniimagenet.3@40-50 --beta=0.0 --whiten --arch resnet18 --epochs 400 --decay_start_epoch 50 --batch 64  --lr 0.0002
